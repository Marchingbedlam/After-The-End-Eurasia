NDefines = {
	...
	NDiplomacy = {
		...
		DEMAND_RELIGIOUS_CONVERSION_INTERACTION_PIETY = 150,
	...
	NTechnology = {
		DONT_EXECUTE_TECH_BEFORE = 2666,												-- Set this to your earliest starting year
	...
	NEngine = {
		...
		COURTIER_EVENT_PROCESS_OFFSET = 120,											-- Events are checked every X day for courtiers. Max value of 255
